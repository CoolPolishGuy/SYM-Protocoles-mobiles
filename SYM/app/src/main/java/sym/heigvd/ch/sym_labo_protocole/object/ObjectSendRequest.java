 ...
 * This class is similar to the AsyncSendRequest and DifferateSendRequest, however we want to keep
 ...
 */
public class ObjectSendRequest extends AsyncTask<String, String, String> {
